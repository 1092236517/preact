...
const AdvDetail = observer(() => {
  ...
  const onCopy = useCallback((text, result) => {
    ...
    _czc.push(['_trackEvent', '制造业详情', '复制微信'])
  })
  ...
  return <div className={classes.page}>
    {
      ...
      <div className={classes.backPage}>
        <img src={`${optImageUrl('http://recruit-public.oss-cn-shanghai.aliyuncs.com/tmp/963b1bf6ac8c47f464c952cb6e589a88.jpg', { w: 20, h: 0 })}`} className={classes.backImg} alt="周薪薪直聘" onClick={() => {route(`/${localStorage.getItem('locationSearch')}`)}}/>
